...
<aside id="sidebar" class="fixed inset-y-0 left-0 z-50 flex w-64 flex-col justify-between border-r border-slate-800 bg-slate-900 p-5 transition-transform duration-200 ease-in-out -translate-x-full lg:static lg:translate-x-0">
    ...
    <div class="space-y-6">
        ...
        <nav class="space-y-1.5">
            ...
            <a href="#" class="flex items-center justify-between rounded-xl px-3.5 py-2.5 text-base font-medium text-slate-400 hover:bg-slate-800/60 hover:text-slate-200 transition-colors">
                ...
                <span class="text-xs text-slate-400 font-mono">{{ $stats['total_users'] ?? '' }}</span>
            </a>

            <a href="#" class="flex items-center gap-3 rounded-xl px-3.5 py-2.5 text-base font-medium text-slate-400 hover:bg-slate-800/60 hover:text-slate-200 transition-colors">
                <svg class="h-5 w-5 text-slate-400" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
    ...
    <div class="border-t border-slate-800 pt-4 space-y-2">
        ...
        <div class="px-2 py-1">
            ...
            <p class="truncate text-xs text-slate-400">@<span>{{ auth()->user()->username }}</span></p>
        </div>
        @endauth
